...
public class BudgetServiceTest {
    ...
    @InjectMocks
    private BudgetServiceImpl savingService;
    ...
    public void createSavingTest() {
        ...
        // when
        Budget savedBudget = savingService.create(user, budgetDto);
...
//        assertThat(foundBudget).isEqualTo(budget);
    ...
    @Test
    public void findSavingByUserTest() {
        // given
        List<Budget> budgets = new ArrayList<>();
        when(budgetRepository.findByUser(user)).thenReturn(budgets);

        // when
        //List<Budget> budgetList = savingService.findByUser(user);
